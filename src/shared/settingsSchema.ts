...
export const SETTING_FIELDS: readonly SettingField[] = [
  ...
  },
  {
    ...
    section: "diagnostics",
    description: {
      en: "Write verbose debug output (with secret redaction) to the \"Chat Sidebar for OpenCode\" output channel.",
      zhTW: "將詳細除錯輸出（含密鑰遮蔽）寫入「Chat Sidebar for OpenCode」輸出頻道。",
    },
  },
  {
