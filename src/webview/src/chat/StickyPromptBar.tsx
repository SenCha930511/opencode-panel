...
export function StickyPromptBar(props: {
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute inset-x-0 top-0 z-20 bg-bg pl-4.5 sm:pl-5 pr-[calc(1.125rem+6px)] sm:pr-[calc(1.25rem+6px)] pt-2 pb-2 transition-all duration-200 ease-out oc-sticky-enter"
    >
      <button
        type="button"
